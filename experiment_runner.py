...
def train_green_detection():
    ...
    # After all training loops, generate visualizations
    import subprocess
    print("Generating specialty and color association visualizations...")
    subprocess.run(["python3", "plot_specialties.py"])
    subprocess.run(["python3", "plot_color_associations.py"])
    print("Visualization images saved to training_logs/")
